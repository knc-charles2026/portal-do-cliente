  ...
  const columns = [
    {
      ...
      renderCell: (params) => {
        ...
        if (/andamento/i.test(value)) chipProps.color = "info";
        else if (/concluído/i.test(value)) chipProps.color = "success";
        else if (/análise/i.test(value)) chipProps.color = "warning";
        else if (/cancelado/i.test(value)) chipProps.color = "error";
        else chipProps.variant = "outlined";

        return <Chip {...chipProps} />;
      },
    },
    { field: "status_validacao", headerName: "Status Final", flex: 1 },
    { field: "observacao_knc", headerName: "Observações KNC", flex: 2 },
    { field: "data_alteracao", headerName: "Data Alteração", flex: 1 },
    { field: "data_hora", headerName: "Data/Hora", flex: 1 },
    { field: "email_rv", headerName: "Email Revenda", flex: 1.5 },
    { field: "nome_rv", headerName: "Nome Revenda", flex: 1.5 },
    { field: "cnpj_rv", headerName: "CNPJ Revenda", flex: 1.2 },
    { field: "contato_rv", headerName: "Contato Revenda", flex: 1.2 },
    { field: "telefone_rv", headerName: "Telefone Revenda", flex: 1.2 },
    { field: "razao_social_cf", headerName: "Razão Social Cliente Final", flex: 2 },
    { field: "cnpj_cf", headerName: "CNPJ Cliente Final", flex: 1.2 },
    { field: "contato_cf", headerName: "Contato Cliente Final", flex: 1.2 },
    { field: "email_cf", headerName: "Email Cliente Final", flex: 1.5 },
    { field: "cargo_cf", headerName: "Cargo Cliente Final", flex: 1.2 },
    { field: "telefone_cf", headerName: "Telefone Cliente Final", flex: 1.2 },
    { field: "aplicacoes_setorizacao", headerName: "Aplicações / Setorização", flex: 2 },
    { field: "produto_codigo", headerName: "Código Produto", flex: 1 },
    { field: "produto_descricao", headerName: "Descrição Produto", flex: 2 },
    { field: "produto_marca", headerName: "Marca Produto", flex: 1 },
    { field: "qtde", headerName: "Quantidade", flex: 1 },
    { field: "concorrencia", headerName: "Concorrência", flex: 2 },
    { field: "produto_modelo", headerName: "Modelo Produto", flex: 1.5 },
  ];
  ...
  return (
    <div className={`${temaEscuro ? "bg-gray-900 text-white" : "bg-white text-black"} bg-opacity-90 rounded-2xl shadow-md overflow-hidden`}>
      ...
      <div className="p-4 sm:p-6"> 
        ...
        >
          <h1 className="text-sm font-bold mb-4 col-span-2">
          ...
          <button
            type="submit"
            className="col-span-2 bg-[#1e293b] text-white py-2 px-4 rounded hover:bg-blue-700"
          >
