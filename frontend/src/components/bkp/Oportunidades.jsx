 ...
 {/*      <header className="flex items-center justify-between bg-[#002855] p-4">
      ...
      <div className="p-4 sm:p-6">
        <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6 bg-[#e2e8f0] p-3 rounded-lg">
          <input type="text" name="numero_serie" placeholder="Número de Série" value={formData.numero_serie} onChange={handleChange} className="p-2 border rounded" />
          <input type="text" name="modelo" placeholder="Modelo" value={formData.modelo} onChange={handleChange} className="p-2 border rounded" />
          <input type="text" name="cliente" placeholder="Cliente" value={formData.cliente} onChange={handleChange} className="p-2 border rounded" />
          <input type="text" name="danfe" placeholder="Nota Fiscal" value={formData.danfe} onChange={handleChange} className="p-2 border rounded" />
          <input type="text" name="nfe44" placeholder="Chave NFe" value={formData.nfe44} onChange={handleChange} className="p-2 border rounded" />
          <input type="date" name="data_compra" placeholder="Data da Compra" value={formData.data_compra} onChange={handleChange} className="p-2 border rounded" />
          <input type="date" name="data_envio" placeholder="Data do Envio" value={formData.data_envio} onChange={handleChange} className="p-2 border rounded" />
          <input type="date" name="data_vencimento" placeholder="Vencimento da Garantia" value={formData.data_vencimento} onChange={handleChange} className="p-2 border rounded" />
        <div class="col-span-2 flex justify-end">          
          <button  type="submit"  class="bg-[#1e293b] text-white px-4 py-2 rounded hover:bg-blue-500">Inserir Registro</button>
        </div>
        </form>
        <h2 className="text-xl font-bold mb-4">Painel do Cliente</h2>
