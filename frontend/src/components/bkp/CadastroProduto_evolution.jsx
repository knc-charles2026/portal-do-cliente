...
export default function CadastroProduto() {
  ...
  {/* Definir as Colunas da Grid e sua largura mínima */}
 ...
 {/*      <header className="flex items-center justify-between bg-[#002855] p-4">
      ...
      <nav className="flex items-center justify-between px-4 py-3 bg-[#002855] shadow-md">
        <div className="flex items-center gap-3">
          ...
          <span onClick={CadastroProduto} className="text-white text-lg font-semibold"> </span> {/* Título dinâmico */}
        </div>
          <div className="flex items-center gap-4">
          <span className="text-white text-sm">Bem vindo! {usuario.nome} ({usuario.nivel})</span>
      ...
      <div className="p-4 sm:p-6"> 
        ...
        <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6 bg-[#e2e8f0] p-3 rounded-lg">  <h1 className="text-sm font-bold mb-4 col-span-2">Registro de Oportunidades</h1>
