...
const handleImportarXLSX = async (e) => {
  ...
  try {
    const response = await axios.post(
      "http://localhost:8000/oportunidades/importar-xlsx/",
      formData,
      {
...
//////////////////////////////////////////////////////
  ...
  const handleSalvar = async () => {
    try {
      ...
      if (modo === "create") {
        await axios.post("http://localhost:8000/oportunidades/", payload);
        ...
        await axios.put(`http://localhost:8000/oportunidades/${id}/`, payload);
...
>
  ...
  <input
      name={field.name}
    value={formData[field.name] || ""}
    className="border rounded p-2 w-1/2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 col-span-2"
